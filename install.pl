...
copyfile("cfg_example_root", "$prefix/cfg_example_root");
system ("chmod 600 $prefix/cfg_example_root");
copyfile("cfg_example_local", "$prefix/cfg_example_local");
system ("chmod 600 $prefix/cfg_example_local");
